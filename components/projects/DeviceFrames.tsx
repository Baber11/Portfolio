...
export const PhoneFrame = memo(function PhoneFrame({
  ...
  return (
    <div className={`relative mx-auto w-full max-w-[220px] ${className}`}>
      <div className="device-glow pointer-events-none absolute -inset-4 hidden rounded-[2.5rem] bg-cyan-400/15 md:block" />
...
export const BrowserFrame = memo(function BrowserFrame({
  ...
  return (
    <div className={`relative w-full ${className}`}>
      <div className="device-glow pointer-events-none absolute -inset-3 hidden rounded-2xl bg-teal-400/10 md:block" />

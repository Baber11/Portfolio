...
export const PhoneFrame = memo(function PhoneFrame({
  ...
  return (
    <div className={`relative mx-auto w-full max-w-[220px] ${className}`}>
      <div className="pointer-events-none absolute -inset-4 rounded-[2.5rem] bg-cyan-400/15 blur-2xl" />
      <div className="relative overflow-hidden rounded-[1.75rem] border border-white/20 bg-[#020617] p-[7px] shadow-[0_20px_50px_rgba(0,0,0,0.55),0_0_40px_rgba(34,211,238,0.18)]">
...
export const BrowserFrame = memo(function BrowserFrame({
  ...
  return (
    <div className={`relative w-full ${className}`}>
      <div className="pointer-events-none absolute -inset-3 rounded-2xl bg-teal-400/10 blur-2xl" />
      <div className="relative overflow-hidden rounded-xl border border-white/15 bg-[#0a1220] shadow-[0_24px_60px_rgba(0,0,0,0.5),0_0_30px_rgba(45,212,191,0.12)]">
